	...
	<div class="search-title">
		<form action="findPwd.me" id="findPwd_form" name="findpwd_form" method = "post" >
			<div>
				...
				<div class = "find-name">
					<label>아이디</label>
					<input type="text" id="conId" name="conId" class="form-control" minlength="7" maxlength="20" placeholder="띄어쓰기없는 영문,숫자 7~20자">
					<span class="error_next_box" id="idMsg"></span>
				</div><br>
				<div class="find-email">
					<label>이메일</label>
					<input type="email" id="conEmail" name="conEmail" class="form-control" placeholder="ex)email@gmail.com">
					<span class="error_next_box" id="emailMsg">이메일 주소를 다시 확인해주세요.</span>
				</div><br>
				<div>
					<!-- 이메일 본인인증 -->
                    <button id="emailConfirmBtn" class="btn btn-outline-dark" type="button">이메일 본인인증</button>
					<br><br>
			...
			<br>
			<div class="btnSearch">
				<button type="button" id="findPwdBtn" class="btn btn-dark btn-block" style="background-color : black;" data-toggle="modal" data-target="#myModal">비밀번호 변경하기</button>
